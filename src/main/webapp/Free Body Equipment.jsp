    ...
    <div class="product mt-5 text-center">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="card">
                        <img src="Free Body 1.jpg" alt="" style="height: 300px;">
                        <div class="card-body">

                            <div class="product-name">
                                <p>Free Weights-Body-solid Machine</p>
                ...
                <div class="col-lg-3">
                    <div class="card">
                        <img src="Free Body 2.jpg" alt="" style="height: 300px;">
                        <div class="card-body">

                            <div class="product-name">
                                <p>Body solid Home Gym Exercise Equipments</p>
                                <p> <span>$39.99</span> $29.99</p>
                            </div>
                            <div class="button">
                                <button class="btn btn-primary" type="submit" style="margin-left: 100px">Add to card</button>
                ...
                <div class="col-lg-3">
                    <div class="card">
                        <img src="Free Body 3.jpg" alt="" style="height: 300px;">
                        <div class="card-body">

                            <div class="product-name">
                                <p>Fit Machine Free Weight Gym Equipment</p>
                                <p> <span>$39.99</span> $29.99</p>
                            </div>
                ...
                <div class="col-lg-3">
                    <div class="card">
                        <img src="Free Body 4.jpg" alt="" style="height: 300px;">
                        <div class="card-body">

                            <div class="product-name">
                                <p>Olympic Lower Body Machines & Equipments</p>
                                <p> <span>$39.99</span> $29.99</p>
                            </div>
